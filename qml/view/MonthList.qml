...
Page {
    ...
    property string theMonthString: eTransaksi.month
    onTheMonthStringChanged:dayTimer.running = true
    ...
    Timer{
        ...
        onTriggered: {
            ...
            eTransaksi.selectMonth(mother.currentDate);
            datemodel.clear();
            console.log(JSON.stringify(eTransaksi.month));
            var jicons = JSON.parse(eTransaksi.month).transaksi;
            var balance = 0;
